                    ...
                    {pathname === "/" ? (
                        ...
                        >
                            <span aria-hidden className="text-brand transition-colors">
                                <svg viewBox="0 0 220 100" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
                        ...
                        <Link href="/" className="flex items-center gap-2.5">
                            <span aria-label="01X Logo" className="text-brand transition-colors">
